...
@WebServlet(name = "CaseListQrySelfSubscribe",urlPatterns = "/admin/case/qry/selfsubscribe")
/**
 * http://localhost:8080/admin/case/qry/selfsubscribe?page_no=1
 */
public class CaseListQrySelfSubscribe extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        if (page_no > 0) {
            out.append(caseService.querySelfSubcribe(current_user,current_user_type,page_no,10));
        }
    }
