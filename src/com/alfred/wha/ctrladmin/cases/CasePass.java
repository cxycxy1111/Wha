...
@WebServlet(name = "CasePass",urlPatterns = "/admin/case/pass")
/**
 * http://localhost:8080/admin/case/pass?id=1
 */
public class CasePass extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(caseService.pass(event,current_user,current_user_type));
    }
