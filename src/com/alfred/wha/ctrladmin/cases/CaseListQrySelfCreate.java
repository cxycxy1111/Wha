...
@WebServlet(name = "CaseListQrySelfCreate",urlPatterns = "/admin/case/qry/selfcreate")
/**
 * http://localhost:8080/admin/case/qry/selfcreate
 */
public class CaseListQrySelfCreate extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(caseService.querySelfCreate(current_user,current_user_type));
    }
