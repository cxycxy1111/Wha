...
@WebServlet(name = "CaseDelted",urlPatterns = "/admin/case/delete")
/**
 * http://localhost:8080/admin/case/delete?id=1
 */
public class CaseDelete extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(caseService.delete(id,current_user,current_user_type));
    }
