...
@WebServlet(name = "CaseListQryRejected",urlPatterns = "/admin/case/qry/rejected")
/**
 * http://localhost:8080/admin/case/qry/rejected
 */
public class CaseListQryRejected extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(caseService.queryRejected());
    }
