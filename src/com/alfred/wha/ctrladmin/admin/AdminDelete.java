...
@WebServlet(name = "AdminDelete",urlPatterns = "/admin/admin/delete")
/**
 * localhost:8080/admin/admin/delete?id=1
 */
public class AdminDelete extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(adminUserService.delete(Tool.requestToLong(request,"id"),current_user,current_user_type));
    }
