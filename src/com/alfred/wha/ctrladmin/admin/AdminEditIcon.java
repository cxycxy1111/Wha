...
@WebServlet(name = "AdminEditIcon",urlPatterns = "/admin/admin/edit/icon")
/**
 * http://localhost:8080/admin/admin/edit/icon
 */
public class AdminEditIcon extends BaseServlet {
