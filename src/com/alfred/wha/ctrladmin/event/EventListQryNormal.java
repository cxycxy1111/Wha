...
@WebServlet(name = "EventListQryNormal",urlPatterns = "/admin/event/qry/normal")
/**
 * http://localhost:8080/admin/event/qry/normal?pange_no=1
 */
public class EventListQryNormal extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) throws IOException {
        ...
        out.append(eventService.queryPassed(page_no,20));
    }
