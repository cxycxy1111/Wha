...
@WebServlet(name = "EventUnsubscribe",urlPatterns = "/admin/event/unsubscribe")
/**
 * http://localhost:8080/admin/event/unsubscribe?id=1
 */
public class EventUnsubscribe extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(eventService.subcribe(current_user,current_user_type,id));
    }
