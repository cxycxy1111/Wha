...
@WebServlet(name = "EventRecover",urlPatterns = "/admin/event/recover")
/**
 * http://localhost:8080/admin/event/recover?id=1
 */
public class EventRecover extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(eventService.recover(id,current_user,current_user_type));
    }
