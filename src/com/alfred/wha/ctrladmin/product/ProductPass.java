...
@WebServlet(name = "ProductPass",urlPatterns = "/admin/product/pass")
/**
 * http://localhost:8080/admin/product/pass?id=1
 */
public class ProductPass extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(productService.pass(Tool.requestToLong(request,"id"), current_user, current_user_type));
    }
