...
@WebServlet(name = "CompanyRecover",urlPatterns = "/admin/company/recover")
/**
 * http://localhost:8080/admin/company/recover?id=1
 */
public class CompanyRecover extends BaseServlet {
