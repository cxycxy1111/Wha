...
@WebServlet(name = "UserRecover",urlPatterns = "/admin/user/recover")
/**
 * http://localhost:8080/admin/user/recover?id=1
 */
public class UserRecover extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(userService.recover(Tool.requestToLong(request,"id"), current_user, current_user_type));
    }
