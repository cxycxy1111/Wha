...
@WebServlet(name = "UserListQryLocked",urlPatterns = "/admin/user/qry/locked")
/**
 * http://localhost:8080/admin/user/qry/locked
 */
public class UserListQryLocked extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) throws IOException{
        ...
        out.append(userService.queryLocked(page_no,10));
    }
