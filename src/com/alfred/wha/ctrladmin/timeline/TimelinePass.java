...
@WebServlet(name = "TimelinePass",urlPatterns = "/admin/timeline/pass")
/**
 * http://localhost:8080/admin/timeline/pass?id=1
 */
public class TimelinePass extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(timelineService.pass(id,current_user,current_user_type));
    }
