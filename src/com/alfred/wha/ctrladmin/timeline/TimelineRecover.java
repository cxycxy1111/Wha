...
@WebServlet(name = "TimelineRecover",urlPatterns = "/admin/timeline/recover")
/**
 * http://localhost:8080/admin/timeline/recover?id=1
 */
public class TimelineRecover extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) {
        ...
        out.append(timelineService.recover(id,current_user,current_user_type));
    }
