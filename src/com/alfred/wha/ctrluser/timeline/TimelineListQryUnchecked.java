...
@WebServlet(name = "UserTimelineListQryUnchecked",urlPatterns = "/user/timeline/qry/unchecked")
/**
 * http://localhost:8080/admin/timeline/qry/normal
 */
public class TimelineListQryUnchecked extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) throws IOException {
        ...
        out.append(timelineService.queryUnchecked(page_no,10));
    }
