...
@WebServlet(name = "UserTimelineReject",urlPatterns = "/user/timeline/reject")
/**
 * http://localhost:8080/admin/timeline/reject?id=1
 */
public class TimelineReject extends BaseServlet {
