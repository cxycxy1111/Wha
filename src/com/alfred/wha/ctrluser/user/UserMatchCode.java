...
@WebServlet(name = "UserMatchCode",urlPatterns = "/user/user/matchCode")
/**
 * http://localhost:8080/admin/user/lock?id=1
 */
public class UserMatchCode extends BaseServlet {
    ...
    protected void dealWithSessionDead(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out) throws IOException {
        ...
        out.append(resetPasswordService.matchCode(request.getParameter("email_address"),request.getParameter("code")));
    }
}
