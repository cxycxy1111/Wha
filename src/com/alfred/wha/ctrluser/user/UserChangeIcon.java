...
@WebServlet(name = "UserChangeIcon",urlPatterns = "/user/user/change/icon")
/**
 * http://localhost:8080/admin/user/lock?id=1
 */
public class UserChangeIcon extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) throws IOException {
        ...
        String  imgStr = request.getParameter("icon");
        out.append(userService.changeIcon(current_user,imgStr));
    }
