...
@WebServlet(name = "UserPageAdd",urlPatterns = "/user/page/add")
/**
...
public class PageAdd extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) throws IOException {
        ...
        out.append(pageService.addPage(event_id,page_title,page_summary,content,1,current_user,current_user_type,"","",Tool.getTime(),url));
    }
