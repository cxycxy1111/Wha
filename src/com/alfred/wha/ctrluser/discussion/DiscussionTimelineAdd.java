...
@WebServlet(name = "UserDiscussionTimelineAdd",urlPatterns = "/user/discussion/timeline/add")
/**
 * http://localhost:8080/admin/timeline/qry/creator?creator=1&creator_type=1
 */
public class DiscussionTimelineAdd extends BaseServlet {
    ...
    protected void dealWithSessionAlive(HttpServletRequest request, HttpServletResponse response, HttpSession session, PrintWriter out, long current_user, int current_user_type) throws IOException {
        ...
        long timeline_id = Tool.requestToLong(request,"reference_id");
        ...
        out.append(discussionTimelineService.add(timeline_id,parent_discussion_id,event_id,current_user,current_user_type,source,summary,anonymous));
    }
