        ...
        switch (queryType) {
            case QRY_BY_PRODUCT://根据产品ID精确查询
                builder.append("p.id,")
                        ...
                        .append("p.status,")
                        .append("p.del,")
                        .append("trim(CASE p.creator_type WHEN 0 THEN au.nick_name ELSE u.nick_name END) nick_name,")
                        .append("trim(CASE p.creator_type WHEN 0 THEN au.icon ELSE u.icon END) icon,")
                        .append("p.creator,")
